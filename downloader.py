...
def download_direct(
    ...
    """Download a direct workbook URL without opening a browser."""
    destination_dir.mkdir(parents=True, exist_ok=True)
    destination = destination_dir / Path(expected_filename).name
    request = Request(download_url, headers={"User-Agent": "WorkbookAutomationTool/2.0"})
