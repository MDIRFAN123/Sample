...
class WorkbookProcessor:
    ...
    def _sheet_instructions(cls, sheet_name: str, worksheet_type: str) -> str:
        validation_rules = cls._load_sheet_text(cls.RULES_DIR, worksheet_type)
        if not validation_rules:
            validation_rules = cls._load_sheet_text(cls.RULES_DIR, "generic")
        validation_rules = validation_rules or cls.DEFAULT_VALIDATION_RULES
