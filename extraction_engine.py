...
class PdfExtractionEngine:
    ...
    def process_page(self, pdf_path, page_index, file_id):
        ...
        logger.info("Starting PDF page %s", page_num)
        try:
            ...
            logger.info("Finished PDF page %s", page_num)
    ...
    def extract(self, pdf_path, file_id, progress_state):
        ...
        try:
            with ThreadPoolExecutor(max_workers=workers) as executor:
                futures = {
                    executor.submit(
                        self.process_page, pdf_path, index, file_id
                    ): index
            ...
            progress_state.update({
                ...
                "done": True,
                "status": "failed",
                "error": "The PDF scan could not be completed.",
            })
