...
const UI = {
    ...
    promptWorkbookName:
        document.getElementById("promptWorkbookName"),

    promptWorksheetName:
        document.getElementById("promptWorksheetName"),
...
function regeneratePrompt() {
    ...
    if (UI.promptWorkbookName)
        UI.promptWorkbookName.textContent =
            AppState.workbookName || "—";
    if (UI.promptWorksheetName)
        UI.promptWorksheetName.textContent =
            AppState.selectedSheet || "—";
