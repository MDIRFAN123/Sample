...
const UI = {
    ...
    creditCardMaskResult:
        document.getElementById("creditCardMaskResult"),

    ssnMaskResult:
        document.getElementById("ssnMaskResult"),
...
function renderMaskingSummary() {
    ...
    if (UI.creditCardMaskResult)
        UI.creditCardMaskResult.textContent =
            creditCardCount
                ? `${creditCardCount} Credit Card value${creditCardCount === 1 ? "" : "s"} masked`
                : "No Credit Card values detected";

    if (UI.ssnMaskResult)
        UI.ssnMaskResult.textContent =
            ssnCount
                ? `${ssnCount} SSN value${ssnCount === 1 ? "" : "s"} masked`
                : "No SSN values detected";
