...
function renderMaskingSummary() {
    ...
    UI.maskingSummary.classList.toggle(
        "d-none",
        AppState.maskingSummary.length === 0
    );
...
function resetPromptSafety() {
    ...
    if (UI.promptSafetyAlert) {
        ...
        UI.promptSafetyAlert.innerHTML =
            ...
            "Only Credit Card and SSN are automatically masked. Review the entire prompt before sending it to ChatGPT.";
