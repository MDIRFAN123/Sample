...
const UI = {
    ...
    sheetInstructionsEmptyState:
        document.getElementById("sheetInstructionsEmptyState"),
    ...
    sheetInstructionsModalSubtitle:
        document.getElementById("sheetInstructionsModalSubtitle"),
    ...
    previewWorkbookAttachmentButton:
        document.getElementById("previewWorkbookAttachmentBtn"),
...
function registerBaseEvents() {
    ...
    UI.previewWorkbookAttachmentButton?.addEventListener(
        "click",
        showSelectedWorkbookPreview
    );
...
function renderSheetInstructionSummary(selectedSheets) {
    ...
    UI.sheetInstructionsModalSubtitle.textContent = [
        UI.sheetTemplateName.textContent,
        ...selectedSheets.map(item => item.name)
    ].join(" · ");
    UI.sheetInstructionsEmptyState?.classList.add("d-none");
...
function registerPromptBuilderEvents() {
    ...
    UI.openSheetInstructionsButton?.addEventListener(
        "click",
...
function showSheetInstructionsEmptyState(
    title = "Waiting for workbook...",
    message = "Upload a workbook to load the validation template."
) {

    UI.sheetInstructionsEmptyState?.classList.remove("d-none");
    UI.sheetInstructionsDetails?.classList.add("d-none");
    if (UI.sheetInstructionsEmptyState) {
        const titleElement = UI.sheetInstructionsEmptyState.querySelector("strong");
        const messageElement = UI.sheetInstructionsEmptyState.querySelector("span");
